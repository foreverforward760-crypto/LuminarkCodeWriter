...
STAGE_METADATA: dict[int, dict] = {
    ...
    1: {"name": "The Spark",             "geometry": "Point",    "arc": "descending",
        "physical_stability": False, "conscious_stability": True,  "tumbling_coeff": 0.2},
    2: {"name": "The Vessel",            "geometry": "Line",     "arc": "descending",
        "physical_stability": True,  "conscious_stability": False, "tumbling_coeff": 0.3},
    3: {"name": "The Engine",            "geometry": "Triangle", "arc": "descending",
        "physical_stability": False, "conscious_stability": True,  "tumbling_coeff": 0.4},
    4: {"name": "The Crucible",          "geometry": "Square",   "arc": "descending",
        "physical_stability": True,  "conscious_stability": False, "tumbling_coeff": 0.5},
    5: {"name": "The Dynamo",            "geometry": "Pentagon", "arc": "bifurcation",
        "physical_stability": False, "conscious_stability": True,  "tumbling_coeff": 0.6},
    6: {"name": "The Nexus",             "geometry": "Hexagon",  "arc": "ascending",
        "physical_stability": True,  "conscious_stability": False, "tumbling_coeff": 0.7},
    7: {"name": "The Lens",              "geometry": "Heptagon", "arc": "ascending",
        "physical_stability": False, "conscious_stability": True,  "tumbling_coeff": 0.8},
    8: {"name": "The Vessel of Grounding","geometry": "Octagon", "arc": "ascending",
        "physical_stability": True,  "conscious_stability": False, "tumbling_coeff": 0.9},
    9: {"name": "The Transparency",      "geometry": "Nonagon",  "arc": "ascending",
        "physical_stability": False, "conscious_stability": True,  "tumbling_coeff": 1.0},
}
...
class SAPGeometry:
    ...
    def classify(x: list[float]) -> int:
        ...
        distances = {
            ...
            for s, c in STAGE_CENTROIDS.items()
        }
    ...
    def compute_micro_position(x: list[float], stage: int) -> float:
        ...
        dot_num = sum(
            AXIS_WEIGHTS[i] * observed[i] * direction[i] / (AXIS_SCALES[i] ** 2)
            for i in range(5)
        )
        dot_den = sum(
            AXIS_WEIGHTS[i] * direction[i] ** 2 / (AXIS_SCALES[i] ** 2)
            for i in range(5)
        )
